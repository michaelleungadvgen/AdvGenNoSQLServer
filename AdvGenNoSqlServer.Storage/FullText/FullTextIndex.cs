...
public class FullTextIndex : IFullTextIndex
{
    ...
    // Incremental counter for total tokens in corpus
    ...
    public FullTextSearchResult Search(string query, FullTextSearchOptions? options = null)
    {
        ...
        try
        {
            ...
            // Calculate invariant score inputs exactly once
    ...
    private double GetAverageDocumentLength()
    {
        ...
        long total = Interlocked.Read(ref _totalTokenCount);
    ...
    public FullTextIndexStats GetStats()
    {
        ...
        double avgLength = _documents.Count == 0 ? 0 : GetAverageDocumentLength();
