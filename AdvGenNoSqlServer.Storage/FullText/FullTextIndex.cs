...
public class FullTextIndex : IFullTextIndex
{
    ...
    // Incremental tracking of total tokens for O(1) stats
    ...
    public FullTextSearchResult Search(string query, FullTextSearchOptions? options = null)
    {
        ...
        try
        {
            ...
            // Hoist average length calculation out of the loop
    ...
    private double GetAverageDocumentLength()
    {
        ...
        return (double)Interlocked.Read(ref _totalTokenCount) / docCount;
    }
    ...
    public FullTextIndexStats GetStats()
    {
        ...
        double avgLength = GetAverageDocumentLength();
