...
public class QueryExecutor : IQueryExecutor
{
    ...
    public async Task<bool> ExistsAsync(Query.Models.Query query, CancellationToken cancellationToken = default)
    {
        ...
        // Apply filters and check for existence
        // OPTIMIZATION: Use .Any() instead of .LongCount() to short-circuit enumeration
        // improving performance from O(N) to O(1) in the best case when a match is found early.
