...
public class EncryptionService : IEncryptionService
{
    ...
    public EncryptionService(ServerConfiguration configuration, IKeyStore? keyStore = null, ILogger<EncryptionService>? logger = null)
    {
        ...
        else
        {
            ...
            _logger?.LogWarning("A secure random master key was generated automatically due to missing configuration. Data encrypted with this key will be unrecoverable if the key is not persisted.");
        }
